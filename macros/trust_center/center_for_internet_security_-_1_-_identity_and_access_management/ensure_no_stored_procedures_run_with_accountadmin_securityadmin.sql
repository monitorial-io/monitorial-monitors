{% macro ensure_no_stored_procedures_run_with_accountadmin_securityadmin() -%}
...
where
    snowflake.trust_center.time_series_daily_findings.scanner_id = 'CIS_BENCHMARKS_CIS1_17'
{%- endmacro %}
