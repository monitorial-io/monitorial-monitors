{% macro ensure_no_stored_procedures_owned_by_accountadmin_securityadmin() -%}
...
where
    snowflake.trust_center.time_series_daily_findings.scanner_id = 'CIS_BENCHMARKS_CIS1_16'
{%- endmacro %}
