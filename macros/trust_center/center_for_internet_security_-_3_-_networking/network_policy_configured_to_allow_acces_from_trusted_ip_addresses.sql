{% macro network_policy_configured_to_allow_acces_from_trusted_ip_addresses() -%}
...
where
    snowflake.trust_center.time_series_daily_findings.scanner_id = 'CIS_BENCHMARKS_CIS3_1'
{%- endmacro %}
